...
## Overview
The Advanced Search feature allows users to filter and sort their journal notes to quickly find specific content. This goes beyond simple keyword matching by including date range filtering and flexible sorting options.
...
- **Dashboard**: The main dashboard provides a search bar and a "Filter" button.
...
## Future Enhancements
- Save search presets.
- Search within specific notebooks or tags (if implemented).
